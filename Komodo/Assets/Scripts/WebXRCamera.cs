    ...
    public class WebXRCamera : MonoBehaviour
    {
            ...
            Matrix4x4 sitStandMatrix)
        {
            if (xrActive)
            {
                ...
                //   Debug.Log("CameraL : Frostrum" + cameraL.nearClipPlane + " " + cameraL.farClipPlane + " FOV " + cameraL.fieldOfView + " ; position = " + cameraL.transform.position + " ; rotation = " + cameraL.transform.rotation + " MATRIXINFO  POS: " + leftProjectionMatrix.GetColumn(3) + " Rot " + leftProjectionMatrix.GetColumn(2));
